...
Milkshaker is a Solana VolumeBot/Washtrader that continuously uptrends the chart, increases volume, and trade count.\
...
- Analytics: Single analytic report, Single token report, Lifetime report, Full wallet action and token/sol volume created, session duration etc.
